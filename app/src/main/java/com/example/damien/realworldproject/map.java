...
public class map extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {
...
// Toast instructing user to tap on the mapboxMap
                Toast.makeText(
                        map.this,
                        "Find your location", Toast.LENGTH_SHORT).show();

// When user is still picking a location, we hover a marker above the mapboxMap in the center.
// This is done by using an image view with the default marker found in the SDK. You can
// swap out for your own marker image, just make sure it matches up with the dropped marker.
                hoveringMarker = new ImageView(map.this);
...
// Transform the appearance of the button to become the cancel button
                            selectLocationButton.setBackgroundColor(
                                    ContextCompat.getColor(map.this, R.color.colorAccent));
...
// Switch the button appearance back to select a location.
                            selectLocationButton.setBackgroundColor(
                                    ContextCompat.getColor(map.this, R.color.colorPrimary));
...
// Add the marker image to map
    ...
    public void onExplanationNeeded(List<String> permissionsToExplain) {
        Toast.makeText(this, "Explain", Toast.LENGTH_LONG).show();
    }
